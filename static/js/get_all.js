function getAll() {
    ...
    request.open('GET', 'https://8000-gustavodelra-apidisback-4p3t9uybpfx.ws-us106.gitpod.io');
...
function deleteOne(id) {
    ...
    if (confirmacion) {
        ...
        var request = new XMLHttpRequest();
        request.open('DELETE', 'https://8000-gustavodelra-apidisback-4p3t9uybpfx.ws-us106.gitpod.io/' + encodeURIComponent(id));
